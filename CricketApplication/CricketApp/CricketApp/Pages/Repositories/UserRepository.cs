...
public class UserRepository
{
    ...
    {
        string connectionString = "Server = localhost; Port = 3306; Database = cricketdb; Uid = root; Pwd = admin;";
        //Server = localhost; Port = 3306; Database = cricketdb; Uid = root; Pwd = admin;
